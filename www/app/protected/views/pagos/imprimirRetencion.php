...
<tr>
  <td>
    <strong>Apellido y Nombre o Denominación: </strong> <?=utf8_decode(Settings::model()->getValorSistema('DATOS_EMPRESA_RAZONSOCIAL'))?><br>
    <strong>Domicilio: </strong><?=utf8_decode(Settings::model()->getValorSistema('DATOS_EMPRESA_DOMFISCAL'))?><br>
...
<tr>
  <td>
    <strong>Concepto: </strong><?=$model->profesional->regimen=='actual'?'Profesionales Liberales(Cod. 116)':'Profesionales (Cod. 94)'?><br>
...
<img src='images/firma.png'/><br>
<b>Sonia R. Echaniz</b><br>
<small>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GERENTE</small>
</div>