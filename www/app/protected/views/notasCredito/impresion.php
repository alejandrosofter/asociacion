...
<tr> <th style='width:100%;text-align: center;'> <span style=" border: 1px solid black;font-size: 70px;width: 30px "> C </span> 
  ...
  <tr> <th style='width:100%;text-align: center;'> <span style=" font-size: 9px;width: 30px "> Cod. <?=$model->tipoComprobante?> <?=isset($duplicado)?"DUPLICADO":"ORIGINAL";?></span> 
  </th></tr>
<tr><th>
    ...
    <div class='cabezal'>
      <table>
        <tr>
          ...
          <td>
            <strong>NRO <?=str_pad($model->puntoVenta, 4, "0", STR_PAD_LEFT)." - ".str_pad($model->nroComprobante, 6, "0", STR_PAD_LEFT)?></strong>
            <br><br>
            <div style="font-size: 20px;font-weight: bold;"><?=$model->tipoComprobanteElectronico->nombre?></div>  
<br>
...
<tr> <th style='width:100%;text-align: right;font-size: 10px;font-weight: normal;padding: 10px'><b>CAE:</b><?=$model->codigo;?> <b>Vto:</b><?=$model->vto;?></th></tr>
