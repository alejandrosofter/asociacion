...
<div class="span7"> 
	...
	<h1>CTA CTE<small> a la fecha</small> </h1>
		...
		<tr><th>Fecha</th><th>Tipo</th><th>$ Ret.</th><th>$ Asoc.</th><th>$ Chq.</th><th>Estado</th><th>$ Importe</th><th>$ SALDO</th></tr>
		...
		<tr class="<?=$value['estado']=='PENDIENTE'?'seleccionado':''?>">
			...
			<td style="width: 150px"><?=number_format($value['importeRetenciones'],2) ?></td>
			<td style="width: 150px"><?=number_format($value['importeAsociacion'],2) ?></td>
			<td style="width: 150px"><?=number_format($value['importeCheque'],2) ?></td>
			<td><?=$value['estado'] ?></td>
		...
		<?php } ?>
		<tr><th></th><th></th><th></th><th></th><th></th><th></th><th>TOTAL</th><th>$ <?=number_format($sum,2)?></th></tr>
		</table>
	</div>
