...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('facturas-profesional-nomencladores-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Facturas Profesional Nomencladores</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'facturas-profesional-nomencladores-grid',
