...
<div class="sideleft">
    ...
    <div class="sidemenu-wrapper">
      <ul class="sidemenu"> 
        <li class="li13"><a href="index.php?r=articulos/update&id=2">Editar Socios</a></li>
        <li class="li13"><a href="index.php?r=articulos/update&id=1">Editar Obras Sociales</a></li>
