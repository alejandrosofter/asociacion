...
<tr>
	...
	<td>
	<a class='imprime' data-fancybox-type='iframe' href='index.php?r=pagos/detalleMes&idProfesional=<?=$item->idProfesional?>&fecha=<?=$item->fecha?>'><img src='images/iconos/famfam/page.png'/></a> 
