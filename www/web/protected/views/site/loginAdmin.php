...
<div class="themetitle2">
		<div class="themetitlewrapper">	
			<div class="titanictitle">Login Sistema <?=Settings::model()->getValorSistema("DATOS_EMPRESA_FANTASIA")?></div>
        ...
        <div class="onethird">
					<p>
						 En caso de no tener datos para el ingreso por favor contactese a <?=Settings::model()->getValorSistema("DATOS_EMPRESA_EMAILADMIN")?>
					</p>
					<p>
				...
				<div class="twothirdslast">
						...
						<p>Este es el acceso al sistema <span class='colored'> <?=Settings::model()->getValorSistema("DATOS_EMPRESA_FANTASIA")?> </span>. Por favor, rellene el siguiente formulario con sus datos de acceso:</p>
